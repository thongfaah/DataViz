    ...
    return (
        <div className="fixed right-0 top-[10rem] h-[32.3rem] w-[15rem] bg-white  z-50 p-4 overflow-auto border-l border-gray-200">
            ...
            {conditions.map((condition, index) => (
                <div 
                    key={index} 
                    className="mb-4 p-3 rounded-lg shadow-sm bg-gray-100 border-l-4 border-blue-500 relative"
                >
                    <div className="mb-3">
            ...
            <div className="flex justify-between space-x-4 mt-6">
                <button className="bg-gray-200 px-4 py-2 rounded hover:bg-gray-300 w-full">
                    Cancel
                </button>
